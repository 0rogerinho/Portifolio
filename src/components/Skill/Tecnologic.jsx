export const Tecnologic = ({ srcImg }) => {
  return (
    <div className="px-6 py-4 flex justify-center items-center  border border-[#011540] rounded-lg  md:px-9 md:py-6 lg:px-16 lg:py-11 xl:px-[75px] xl:py-12  2xl:px-24 2xl:py-14">
      <img
